...
<div class="model-settings-sidebar">
    <div class="model-settings-sidebar-inner">
        <?php 
            $type = 'turnon-light';
            $image = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100"><path d="M50 10c-15 0-27 12-27 27 0 10 5 18 12 23 2 1 3 3 3 5v2h24v-2c0-2 1-4 3-5 7-5 12-13 12-23 0-15-12-27-27-27z" fill="#FFD54F"/><rect x="38" y="70" width="24" height="8" fill="#555"/><rect x="40" y="80" width="20" height="6" fill="#777"/></svg>';
            $title = __('Lights On', 'furniture-config');
        ?>
