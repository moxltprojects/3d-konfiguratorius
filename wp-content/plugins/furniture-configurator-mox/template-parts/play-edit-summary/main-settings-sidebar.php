<div class="main-settings-sidebar">
    <div class="main-settings-sidebar-inner">
        <div class="main-tabs">
            ...
            ?>
            <?php include $template_parts_url ."/play-edit/button-with-image.php"; ?>
        ...
        <div class="main-content">
            <?php include $template_parts_url ."/play-edit/cabinets/index.php"; ?>
            <?php include $template_parts_url ."/play-edit/colors/index.php"; ?>
            <?php include $template_parts_url ."/play-edit/dimensions/index.php"; ?>
        </div>
    </div>
</div>